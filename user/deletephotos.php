...
<?php 
		...
		if(isset($_POST['deletepicture']))
        {
			...
			$_SESSION['photoss'] = $_POST['isSet'];
			
			//exit;
			echo '<meta http-equiv="refresh" content="0;url=./deletepicture.php">';	
        }
		?>
<!DOCTYPE html>
<html>
		...
		else
		{
				if ($data->email == $email)
				{
                   ...
                   .imgsizee 
					...
					<?php
						echo '<h1 id="SOONN">DELETE PHOTOS</h1>'; 
                ...
                <div id="photoalbum">
                    <form method="POST" action="./deletephotos.php" >  
                    <?php
                       ...
                       while($data = $result->fetch_object())   
                       {
                           if($data->isSet == "T")
                           {
                            //$isSett = "checked=\"checked\" disabled ";   
                           }
                           else
                           {
                            $isSett = "";   
                    ...
                    <input type="checkbox" id="isSet" name="isSet[]" size="100" value="<?php echo $data->id ; ?>"/>
						   <?php
						   }
                        ?>
                    ...
                    <?php } ?>
                     ...
                     <center>
					 <input style="margin-top:3%;" type="submit" name="deletepicture" class="btn btn-success" value="Delete Pictures" onclick="return confirm('Are your sure to delete the selected pictures?');"/>
					 </center>                                                                                                     
